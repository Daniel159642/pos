...
function Calendar({ employee }) {
  ...
  useEffect(() => {
    ...
    if (showFilterDropdown || showScheduleDropdown) {
      document.addEventListener('mousedown', handleClickOutside)
    }
    return () => document.removeEventListener('mousedown', handleClickOutside)
  }, [showFilterDropdown, showScheduleDropdown])
      ...
      <div style={{
        ...
        >
          ...
          >
            ...
            {/* Link calendar to work/business calendar apps (UI only – links to subscription page) */}
            <div style={{
              marginBottom: '20px',
              padding: '14px 16px',
              ...
              <div style={{
                ...
                <Link2 size={18} style={{ flexShrink: 0, opacity: 0.9 }} />
                Link to calendar apps
              </div>
              <p style={{
                margin: '0 0 12px 0',
                fontSize: '13px',
                ...
                Sync this calendar with Google Calendar, Outlook, Apple Calendar, or Calendly.
              </p>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                ...
                >
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0 }} aria-hidden>
