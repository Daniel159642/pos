                  ...
                  >
                    {loadingSubscriptionUrls ? (
                      ...
                      <>
                        ...
                        <button
                          type="button"
                          onClick={() => { window.open(subscriptionUrls.google_url, '_blank'); setShowLinkDropdown(false) }}
                          style={{
                            display: 'flex',
                            alignItems: 'center',
                            gap: '10px',
                        ...
                        <button
                          type="button"
                          onClick={() => { window.open(subscriptionUrls.webcal_url || subscriptionUrls.ical_url, '_blank'); setShowLinkDropdown(false) }}
                          style={{
                            display: 'flex',
                            alignItems: 'center',
                            gap: '10px',
