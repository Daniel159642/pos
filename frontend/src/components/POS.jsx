...
function POS({ employeeId, employeeName }) {
  ...
  return (
    <div className="pos-page" style={{
                  ...
                  <div style={{ marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        justifyContent: 'center',
                        padding: '6px 14px',
                        backgroundColor: scheduledTime ? `rgba(${themeColorRgb}, 1)` : `rgba(${themeColorRgb}, 0.85)`,
                        color: '#fff',
                        border: 'none',
                        borderRadius: '8px',
                        cursor: showPaymentForm ? 'not-allowed' : 'pointer',
                      ...
                      title={scheduledTime ? `Scheduled: ${scheduledTime.toLocaleString()}` : "Schedule pickup"}
                    >
                      <Clock size={16} />
                    </button>
                    <button
                    ...
                    <div style={{
                      ...
                      <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '8px' }}>
                        <button
                          ...
                          title={scheduledTime ? `Scheduled: ${scheduledTime.toLocaleString()}` : "Schedule delivery"}
                        >
                          <Clock size={16} />
                        </button>
                        <button
      ...
      {/* Schedule Modal */}
      {showScheduleModal && (
        <div style={modalOverlayStyle(isDarkMode)}>
          <div style={modalContentStyle(isDarkMode, { maxWidth: '350px' })}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              <FormTitle isDarkMode={isDarkMode} style={{ marginBottom: 0 }}>Schedule Order</FormTitle>
              <button
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <FormField style={{ marginBottom: '12px' }}>
                ...
                <input
                  type="date"
                  value={scheduledTime ? scheduledTime.toISOString().split('T')[0] : new Date().toISOString().split('T')[0]}
                  onChange={(e) => {
            ...
            <CompactFormActions
              ...
              primaryLabel="Save"
              cancelLabel="Clear"
              onPrimary={() => setShowScheduleModal(false)}
              onCancel={() => {
                setScheduledTime(null)
