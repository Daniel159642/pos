...
function createTextTexture(gl, text, font = 'bold 30px monospace', color = 'black') {
    ...
    const fontSize = fontSizeMatch ? parseInt(fontSizeMatch[0], 10) : 30;
...
class Title {
    ...
    createMesh() {
      ...
      `,
        ...
        const textHeight = this.plane.scale.y * 0.25; // increased
...
class App {
    ...
    createMedias(items, bend = 1, textColor, borderRadius, font) {
        const defaultItems = [
            { image: '/product-management.jpg', text: '' },
            { image: '/shipment-automation.jpg', text: '' },
            { image: '/drinks.jpg', text: '' },
            { image: '/gallery-1.jpg', text: '' },
            { image: '/gallery-2.jpg', text: '' },
            { image: '/gallery-3.jpg', text: '' },
            { image: '/gallery-4.jpg', text: '' },
            { image: '/creative.jpg', text: '' },
