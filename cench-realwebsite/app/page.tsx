  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative w-full min-h-[300vh] bg-white overflow-hidden pb-32">
        ...
        <div className="absolute top-[40vh] left-0 w-full min-h-[260vh] z-0 flex flex-col items-center">
          ...
          {[
            { top: '-2%', left: '5%', rotate: -15, scale: 0.4, delay: 0 },
            { top: '15%', left: '85%', rotate: 20, scale: 0.35, delay: 0.5 },
            ...
            { top: '5%', left: '90%', rotate: 15, scale: 0.38, delay: 2.5 },
